#!/bin/bash
# MoGe HiRes ep6 (cosine LR, single phase, mixed, 1600 tokens) — Hypersim Inference
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=16G
#SBATCH --gpus=rtx_3090:1
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_ep6_hypersim_infer_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_ep6_hypersim_infer_%j.err

set -euo pipefail

MODEL_PATH="/cluster/scratch/ayavuz/moge_mixed_output_476644_fixed_cosLR_singlePhase_mixed_HiRes/model_epoch6.pt"
SPLIT="test"
BATCH_SIZE=8
NUM_TOKENS=1600
...
OUTPUT_ROOT="/cluster/scratch/aoezkan/planeseg/hypersim/inference/moge_hires_ep6_h5"
