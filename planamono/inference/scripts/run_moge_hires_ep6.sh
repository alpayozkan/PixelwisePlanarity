#!/bin/bash
# MoGe HiRes ep6 (cosine LR, single phase, mixed, 1600 tokens) — ScanNet++ Inference
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=16G
#SBATCH --gpus=rtx_3090:1
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_ep6_scannetpp_infer_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_ep6_scannetpp_infer_%j.err
...
OUTPUT_ROOT="/cluster/scratch/aoezkan/planeseg/scannetpp/inference/moge_hires_ep6_h5"
