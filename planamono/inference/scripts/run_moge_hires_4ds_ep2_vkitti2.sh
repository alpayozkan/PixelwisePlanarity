#!/bin/bash
# MoGe HiRes 4DS ep2 — VKITTI2 Inference
#SBATCH --time=4:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=16G
#SBATCH --gpus=rtx_3090:1
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_4ds_ep2_vkitti2_infer_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_4ds_ep2_vkitti2_infer_%j.err
...
OUTPUT_ROOT="/cluster/scratch/aoezkan/planeseg/vkitti2/inference/moge_hires_4ds_ep2_h5"
