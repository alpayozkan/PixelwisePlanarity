#!/bin/bash
# MoGe Hypersim Inference → H5 (Mixed BCE Model)
# Run: ./run_moge_hypersim_mixed_bce.sh
...
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hypersim_mixed_bce_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hypersim_mixed_bce_%j.err
...
OUTPUT_ROOT="/cluster/scratch/aoezkan/planeseg/hypersim/inference/moge_mixed_bce_h5"
SPLIT="val"
BATCH_SIZE=8
...
echo "=========================================="
echo "MoGe Hypersim Inference (Mixed BCE)"
echo "=========================================="
