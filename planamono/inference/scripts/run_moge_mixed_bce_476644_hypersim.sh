#!/bin/bash
# MoGe Mixed BCE 476644 (epoch 6) — Hypersim Inference only
#SBATCH --time=24:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=16G
#SBATCH --gpus=rtx_3090:1
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_mixed_bce_476644_hypersim_infer_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_mixed_bce_476644_hypersim_infer_%j.err
...
OUTPUT_ROOT="/cluster/scratch/aoezkan/planeseg/hypersim/inference/moge_mixed_bce_476644_ep6_h5"
