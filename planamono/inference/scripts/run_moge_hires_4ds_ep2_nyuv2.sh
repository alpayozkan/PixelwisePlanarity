#!/bin/bash
# MoGe HiRes 4DS ep2 — NYU-v2 Inference (v5_relative segmentation)
#SBATCH --time=4:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=16G
#SBATCH --gpus=rtx_3090:1
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_4ds_ep2_nyuv2_infer_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_4ds_ep2_nyuv2_infer_%j.err
...
OUTPUT_ROOT="/cluster/scratch/aoezkan/planeseg/nyuv2/inference/moge_hires_4ds_ep2_v5_relative_seg_h5"
...
echo "NYU-v2 inference -> $OUTPUT_ROOT"
mkdir -p "$OUTPUT_ROOT"

python "$PROJECT_ROOT/inference/planarity/inference_to_h5_nyuv2.py" \
