...
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_4ds_ep2_hypersim_infer_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_4ds_ep2_hypersim_infer_%j.err
...
OUTPUT_ROOT="/cluster/scratch/aoezkan/planeseg/hypersim/inference/moge_hires_4ds_ep2_h5"
