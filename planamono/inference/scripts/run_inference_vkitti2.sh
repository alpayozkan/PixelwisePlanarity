#!/bin/bash
# VKITTI2 Inference: MoGe Planarity + Segmentation -> H5
#SBATCH --time=4:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=16G
#SBATCH --gpus=rtx_3090:1
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/vkitti2_infer_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/vkitti2_infer_%j.err
