...
#SBATCH --output=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_4ds_ep1_vkitti2_infer_%j.out
#SBATCH --error=/cluster/scratch/aoezkan/planeseg/logs/inference/moge_hires_4ds_ep1_vkitti2_infer_%j.err
...
OUTPUT_ROOT="/cluster/scratch/aoezkan/planeseg/vkitti2/inference/moge_hires_4ds_ep1_h5"
