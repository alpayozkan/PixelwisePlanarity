#!/bin/bash
# Submit separate SLURM jobs for each baseline method evaluation
...
# All available methods (comment out any you don't want to evaluate)
METHODS=(
    "ours"
    "zeroplane"
    "zeroplane_mixed"
...
echo "Submitting SLURM jobs for baseline evaluation (nonp version)..."
...
echo ""
echo "Check logs:"
echo "  tail -f ${LOG_DIR}/eval_*_nonp_*.out"
echo ""
echo "View errors:"
echo "  tail -f ${LOG_DIR}/eval_*_nonp_*.err"
