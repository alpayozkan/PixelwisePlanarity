...
INPUT_ROOT="${2:-/cluster/scratch/ayavuz/dataset/HP_all/Hypersim_params}"
...
FRAME_SKIP="${5:-1}"
PYTHON_SCRIPT="${6:-/cluster/home/aoezkan/planeseg/PixelwisePlanarity/planamono/gt_creation/hypersim/rendering.py}"
...
source activate planamono 2>/dev/null || conda activate planamono 2>/dev/null || true
