...
from paths import moge_cache_dir as _moge_cache_dir  # noqa: E402
...
class _NYUv2Adapter(_NPZAdapter):
    ...
    def __init__(self, data_root: str, split: str):
        from shared.datasets.nyuv2_plane_dataset import NYUv2PlaneDataset
        self.split = split
...
class _SevenScenesAdapter(_NPZAdapter):
    ...
    def __init__(self, data_root: str, split: str, scene_filter: Optional[List[str]] = None):
        from shared.datasets.sevenscenes_plane_dataset import SevenScenesPlaneDataset
        self.split = split
...
from paths import planarity_model_path as DEFAULT_MODEL_PATH
