...
class _NYUv2Adapter(_NPZAdapter):
    ...
    def __init__(self, data_root: str, split: str):
        from pxwplanar.shared.datasets.nyuv2_plane_dataset import NYUv2PlaneDataset
        self.split = split
...
class _SevenScenesAdapter(_NPZAdapter):
    ...
    def __init__(self, data_root: str, split: str, scene_filter: Optional[List[str]] = None):
        from pxwplanar.shared.datasets.sevenscenes_plane_dataset import SevenScenesPlaneDataset
        self.split = split
...
class _HypersimAdapter(_Adapter):
    ...
    def __init__(self, data_root: str, split: str,
        ...
        from pxwplanar.shared.datasets.hypersim_plane_dataset import HypersimPlaneDataset
        from pxwplanar.paths import hypersim_rendered_path, hypersim_params_path
        self.split = split
