...
def main():
    ...
    for i, (frame_id, frame_data) in enumerate(
        ...
        # (A per-frame compaction or clamping -1 to 0 would either make
        # plane ids inconsistent across frames or collide plane 0 with
        # non-planar.)
