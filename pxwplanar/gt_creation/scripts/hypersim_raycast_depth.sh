...
PARAMS_ROOT="${2:-$(python -c "import sys; sys.path.insert(0, '$REPO_ROOT'); from pxwplanar.paths import hypersim_params_path; print(hypersim_params_path)")}"
...
OUTPUT_ROOT="${4:-$(python -c "import sys; sys.path.insert(0, '$REPO_ROOT'); from pxwplanar.paths import hypersim_merged_path; print(hypersim_merged_path)")}"
FRAME_SKIP="${5:-1}"
