...
from shared.datasets.scannetpp import ScanNetPPPlaneDataset
from paths import (
    repo_path,
    scannetpp_path,
...
METHODS = {
    ...
    # 4-datasets HIRES ep1, two input/output resolution experiments. planes.h5 are
    # produced by segment_signals_to_planes.py (v5_relative, plan>0.3/n<5deg/d_rel<0.025)
    # from the moge_signals_4ds_ep1_<tag> signals dumps.
    "ours_4ds_ep1_640x480": {
        "h5_folder": None,
        "h5_root_override": "/cluster/scratch/aoezkan/planeseg/inference/moge_planes_4ds_ep1_640x480",
        "exp_name": f"moge_4ds_ep1_640x480_{EXP_VER}",
        "display_name": "Ours 4ds ep1 (640x480)",
        "label_offset": 0,
        "nonplanar_label": None,
        "uses_gt_h5": False,
    },
    "ours_4ds_ep1_1920x1440": {
        "h5_folder": None,
        "h5_root_override": "/cluster/scratch/aoezkan/planeseg/inference/moge_planes_4ds_ep1_1920x1440",
        "exp_name": f"moge_4ds_ep1_1920x1440_{EXP_VER}",
        "display_name": "Ours 4ds ep1 (1920x1440)",
        "label_offset": 0,
        "nonplanar_label": None,
        "uses_gt_h5": False,
    },
    ...
    "zeroplane_default_dust3r_released": {
        ...
        # Point at the ZeroPlane test-split inference output (flat <scene>/planes.h5).
        # Layout: inference_test/<exp>/model_<ckpt>/thresh_<val>/<scene>/planes.h5
        "h5_root_override": "/cluster/scratch/aoezkan/planeseg/scannetpp/inference_test/default_dust3r_released/model_0000000/thresh_0.5",
    ...
    "pseudo_planamono": {
        "h5_folder": None,
        "h5_root_override": "/cluster/scratch/aoezkan/planeseg/inference/pseudo_planamono_scannetpp",
        "h5_filename": "rendered_v2.h5",
    ...
    "probe_planamono": {
        "h5_folder": None,
        "h5_root_override": "/cluster/scratch/aoezkan/planeseg/inference/probe_planamono_scannetpp",
        "h5_filename": "rendered_v2.h5",
        "exp_name": f"probe_planamono_{EXP_VER}",
        "display_name": "Probe-Planamono",
        "label_offset": 0,
        "nonplanar_label": None,
        "uses_gt_h5": False,
    },
    ...
    # ── 4ds loss ablations ep2 + v5_relative segmentation ────────────────
    "moge_hires_4ds_focal_ep2_v5_relative_seg": {
        "h5_folder": "moge_hires_4ds_focal_ep2_v5_relative_seg_h5",
        "exp_name": f"moge_hires_4ds_focal_ep2_v5_relative_seg_{EXP_VER}",
        "display_name": "MoGe 4ds Focal ep2 v5_rel (plan=0.3, norm=5°)",
        "label_offset": 0,
        "nonplanar_label": None,
        "uses_gt_h5": False,
    },
    "moge_hires_4ds_dice_ep2_v5_relative_seg": {
        "h5_folder": "moge_hires_4ds_dice_ep2_v5_relative_seg_h5",
        "exp_name": f"moge_hires_4ds_dice_ep2_v5_relative_seg_{EXP_VER}",
        "display_name": "MoGe 4ds DICE ep2 v5_rel (plan=0.3, norm=5°)",
        "label_offset": 0,
        "nonplanar_label": None,
        "uses_gt_h5": False,
    },
    "moge_hires_4ds_mixed_ep2_v5_relative_seg": {
        "h5_folder": "moge_hires_4ds_mixed_ep2_v5_relative_seg_h5",
        "exp_name": f"moge_hires_4ds_mixed_ep2_v5_relative_seg_{EXP_VER}",
        "display_name": "MoGe 4ds Mixed ep2 v5_rel (plan=0.3, norm=5°)",
        "label_offset": 0,
        "nonplanar_label": None,
        "uses_gt_h5": False,
    },
