...
| Method | Scenes | Frames | RI | VOI | SC | P@0.1cm | R@0.1cm | P@0.5cm | R@0.5cm | P@1.0cm | R@1.0cm |
|--------|-------:|-------:|---:|----:|---:|--------:|--------:|--------:|--------:|--------:|--------:|
| GT (upper bound) | 42 | 14439 | 1.000 | 0.000 | 1.000 | 0.603 | 0.440 | 0.940 | 0.682 | 0.968 | 0.701 |
| MoGe (Ours) | 42 | 14439 | 0.807 | 1.740 | 0.647 | 0.660 | 0.390 | 0.903 | 0.541 | 0.935 | 0.560 |
| ZeroPlane (finetuned) | 42 | 14439 | 0.845 | 1.615 | 0.690 | 0.478 | 0.356 | 0.830 | 0.615 | 0.891 | 0.657 |
| ZeroPlane (released) | 42 | 14439 | 0.813 | 2.044 | 0.577 | 0.283 | 0.258 | 0.588 | 0.536 | 0.704 | 0.641 |

### Hypersim (indoor synthetic)

| Method | Scenes | Frames | RI | VOI | SC | P@0.1cm | R@0.1cm | P@0.5cm | R@0.5cm | P@1.0cm | R@1.0cm |
|--------|-------:|-------:|---:|----:|---:|--------:|--------:|--------:|--------:|--------:|--------:|
| GT (upper bound) | 68 | 10646 | 1.000 | 0.000 | 1.000 | 0.997 | 0.786 | 0.999 | 0.787 | 1.000 | 0.787 |
| MoGe (Ours) | 68 | 10646 | 0.756 | 2.815 | 0.504 | 0.793 | 0.433 | 0.831 | 0.452 | 0.849 | 0.461 |
| ZeroPlane (finetuned) | 68 | 10646 | 0.841 | 2.170 | 0.620 | 0.660 | 0.464 | 0.704 | 0.493 | 0.742 | 0.516 |
| ZeroPlane (released) | 68 | 10646 | 0.863 | 2.491 | 0.520 | 0.354 | 0.311 | 0.391 | 0.343 | 0.432 | 0.379 |

### Synthia (outdoor synthetic)

| Method | Scenes | Frames | RI | VOI | SC | P@2.0cm | R@2.0cm | P@5.0cm | R@5.0cm | P@10.0cm | R@10.0cm |
|--------|-------:|-------:|---:|----:|---:|--------:|--------:|--------:|--------:|---------:|---------:|
| GT (upper bound) | 89 | 8426 | 1.000 | 0.000 | 1.000 | 0.782 | 0.390 | 0.819 | 0.411 | 0.848 | 0.430 |
| MoGe (Ours) | 89 | 8426 | 0.760 | 1.705 | 0.640 | 0.958 | 0.320 | 0.971 | 0.325 | 0.977 | 0.327 |
| ZeroPlane (finetuned) | 89 | 8426 | 0.822 | 1.086 | 0.741 | 0.485 | 0.287 | 0.522 | 0.305 | 0.558 | 0.323 |
| ZeroPlane (released) | 89 | 8426 | 0.793 | 1.722 | 0.646 | 0.445 | 0.320 | 0.499 | 0.358 | 0.577 | 0.413 |

### VKITTI2 (outdoor synthetic)

| Method | Scenes | Frames | RI | VOI | SC | P@2.0cm | R@2.0cm | P@5.0cm | R@5.0cm | P@10.0cm | R@10.0cm |
|--------|-------:|-------:|---:|----:|---:|--------:|--------:|--------:|--------:|---------:|---------:|
| GT (upper bound) | 20 | 2360 | 1.000 | 0.000 | 1.000 | 0.997 | 0.199 | 0.999 | 0.200 | 1.000 | 0.200 |
| MoGe (Ours) | 20 | 2360 | 0.790 | 0.937 | 0.808 | 0.967 | 0.242 | 0.989 | 0.248 | 0.998 | 0.250 |
| ZeroPlane (finetuned) | 20 | 2360 | 0.765 | 0.784 | 0.787 | 0.807 | 0.202 | 0.838 | 0.209 | 0.864 | 0.214 |
| ZeroPlane (released) | 20 | 2360 | 0.665 | 1.332 | 0.692 | 0.659 | 0.271 | 0.685 | 0.284 | 0.745 | 0.308 |
